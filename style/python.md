...
Instantiation of code.md for Python. Principles first, tools as options.

## Foundations

Fluent Python (Ramalho). Effective Python (Slatkin). Robust Python (Viafore). Architecture Patterns with Python (Percival/Gregory).

Tooling: ruff (`/Users/m/guide/configs/ruff.toml`), pyright (`/Users/m/guide/configs/pyrightconfig.json`).
